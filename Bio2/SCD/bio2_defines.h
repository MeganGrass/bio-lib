...
#define SYS_SAVE_GAME				0x00040000	// (Write) Save Game (MEMCARD.BIN)
#define SYS_LOAD_GAME				0x00020000	// (Read) Load Game
...
#define STAT_AIM_ROCKET				0x00040000	// Rocket Launcher Aim On/Off
...
#define SCE_POINT4						0x80	// Xz[4][2] is used instead of X, Z, W, D
